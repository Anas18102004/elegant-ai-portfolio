      ...
      <div className="relative z-10 max-w-4xl text-center">
        ...
        >
          <p className="mb-4 text-sm font-medium uppercase tracking-[0.3em] text-muted-foreground">
            AI/ML Engineer · DevOps · Multi-Agent Systems
          </p>
        </motion.div>
        ...
        >
          I build intelligent{" "}
          <span className="neon-text">AI systems</span> &{" "}
          <span className="neon-text">scalable infrastructure</span>
        </motion.h1>
        ...
        >
          Crafting production-grade machine learning pipelines, multi-agent architectures,
          and cloud-native solutions that deliver real-world impact.
        </motion.p>
